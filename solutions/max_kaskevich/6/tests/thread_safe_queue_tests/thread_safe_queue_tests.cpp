...
//
multicast_communication::tests_::detail::thread_safe_queue_many_thread_helper::thread_safe_queue_many_thread_helper( const size_t write_threads_amount, const size_t read_threads_amount )
    : writen_size_( 0ul )
    , readed_size_( 0ul )
{
...
void multicast_communication::tests_::detail::thread_safe_queue_many_thread_helper::write_thread()
{
...
void multicast_communication::tests_::detail::thread_safe_queue_many_thread_helper::read_thread()
{
    size_t amount = 0;
    while ( !queue.empty() )
    {
...
void multicast_communication::tests_::thread_safe_queue_tests()
{
    {
...
void multicast_communication::tests_::thread_safe_queue_many_thread_tests()
{
    detail::thread_safe_queue_many_thread_helper tsqmth( 4ul, 7ul );
}

void multicast_communication::tests_::thread_safe_queue_a_lot_of_thread_tests()
{
